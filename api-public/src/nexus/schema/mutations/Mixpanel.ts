...
import trackCreatePrivateRoom from '../../../app/mixpanel/event/trackCreatePrivateRoom';
...
export const MixpanelMutations = mutationField(t => {
  ...
  t.nonNull.field('trackCreatePrivateRoom', {
    type: 'MutationResult',
    args: {
      sport: nonNull(stringArg()),
      league: stringArg(),
