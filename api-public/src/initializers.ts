...
global.areYouWatchingThisURL = process.env.ARE_YOU_WATCHING_THIS_URL!.toString();

global.areYouWatchingThisAPIKey = process.env.ARE_YOU_WATCHING_THIS_API_KEY!.toString();

global.firebaseAPIKey = process.env.FIREBASE_API_KEY!.toString();
...
global.firebaseConfig = process.env.FIREBASE_CONFIG!.toString();

global.giphyAPIKey = process.env.GIPHY_API_KEY!.toString();
